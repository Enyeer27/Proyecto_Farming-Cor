...
<body>
    <table id="indice-menu">
        <tr>
            <td>
                <ul id="ul-menu">
                    <li class="li-menu"><a class="a-menu" href="../-menu.html">INICIO</a></li>
    ...
    <table id="table-agregar-producto">
        ...
        <form action="p-productos.php">
                <tr>
                    <td colspan="2">
                        <input type="submit" class="submit" name="Ver_productos" value="Ver productos">
                    </td>
                </tr>
            </form>
            <form action="../P-vendedor.html">
                <tr>
                    <td colspan="2">
